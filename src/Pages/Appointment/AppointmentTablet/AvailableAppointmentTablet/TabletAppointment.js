...
const TabletAppointment = ({ option, setTabletBooked }) => {
  ...
  return (
      ...
      <div className="card shadow-xl">
        <div className="card-body">
          ...
          <p className="text-center">
            Price:{" "}
            <span className="text-secondary font-semibold">{price} TK</span>{" "}
          </p>
          <p className="text-center">
            Used: <span className="font-semibold">{usage} </span>{" "}
          </p>
    ...
    //       <p className="text-center">
    //         Price:{" "}
    //         <span className="text-orange-400 font-semibold">{price} TK</span>{" "}
    //       </p>
    //       <p className="text-center">
    //         Used: <span className="font-bold"> {usage} </span>
    //       </p>
    //       <p className="text-center">
    ...
    //         <Link to={`/tabDetails/${_id}`} className="btn btn-primary">
    //           Details
    //         </Link>
