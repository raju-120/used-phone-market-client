    ...
    <div className="mt-5 p-24 bg-base-300 rounded-3xl">
      <div>
        <h2 className="text-center text-4xl font-semibold">
          Please select you'r role, when you are register.
        </h2>
        <div className="mt-16 flex justify-evenly">
          <div className="flex">
            <div>
              <h2 className="text-xl ">
                Are your a{" "}
                <span className="text-sky-500 font-bold">Buyer?</span> <br />
                please{" "}
                <Link to="/buyerRegistration">
          ...
          <div className="flex">
            <div>
              <h2 className="text-xl">
                Are your a{" "}
                <span className="font-bold text-fuchsia-500">Seller?</span>{" "}
                <br />
                please{" "}
